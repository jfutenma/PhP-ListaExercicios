...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu " style="background-color: #14213d !important;"
                            ...
                            <li><a class="dropdown-item nav-fonte nav-selec" href="divs.php">Divisão</a></li>
    ...
    <div class="corpo">
        ...
        <h3 class="txt mt-2 ms-3"><b> Divisão por 10, 5 e 2</b></h3><br>
        <form method="post">
            <span class="txt ms-3">Digite um número </span>
            <input type="text" placeholder="0" class="inputs" name="n1"><br>
            <center>
            ...
            if($_POST){
                ...
                if($n1%10===0){
                    echo "<p class='txt mt-4 mb-3'> O número É divisível por 10.</p>";
                } else{
                    echo "<p class='txt mt-4 mb-3'> O número NÃO É divisível por 10.</p>";
                }
                if($n1%5===0){
                    echo "<p class='txt mt-4 mb-3'> O número É divisível por 5.</p>";
                } else{
                    echo "<p class='txt mt-4 mb-3'> O número NÃO É divisível por 5.</p>";
                }
                if($n1%2===0){
                    echo "<p class='txt mt-4 mb-3'> O número É divisível por 2.</p>";
                } else{
                    echo "<p class='txt mt-4 mb-3'> O número NÃO É divisível por 2.</p>";
                }
            }?>
            </center>
        </div>
