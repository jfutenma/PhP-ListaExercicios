...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu " style="background-color: #14213d !important;"
                            ...
                            <li><a class="dropdown-item nav-fonte nav-selec" href="desc.php">Decrescente</a></li>
    ...
    <div class="corpo">
        ...
        <h3 class="txt mt-2 ms-3"><b> Números Decrescentes</b></h3><br>
        <form method="post">
            <span class="txt ms-3">O primeiro número é </span>
            <input type="text" placeholder="0" class="inputs" name="n1"><br><br>
            <span class="txt ms-3">O segundo número é </span>
            <input type="text" placeholder="0" class="inputs" name="n2"><br><br>
            <span class="txt ms-3">O terceiro número é </span>
            ...
            if($_POST){
                ...
                if ($n1>$n2 && $n1>$n3 && $n2>$n3){
                    echo "<p class='txt mt-4 mb-3'>[$n1, $n2, $n3]</p>";
                } else if ($n1>$n2 && $n1>$n3 && $n3>$n2){
                    echo "<p class='txt mt-4 mb-3'>[$n1, $n3, $n2]</p>";
                    
                } else if ($n2>$n1 && $n2>$n3 && $n1>$n3){
                    echo "<p class='txt mt-4 mb-3'>[$n2, $n1, $n3]</p>";
                } else if ($n2>$n1 && $n2>$n3 && $n3>$n1){
                    echo "<p class='txt mt-4 mb-3'>[$n2, $n3, $n1]</p>";
                } else if ($n3>$n1 && $n3>$n2 && $n1>$n2){
                    echo "<p class='txt mt-4 mb-3'>[$n3, $n1, $n2]</p>";
                } else if ($n3>$n1 && $n3>$n2 && $n2>$n1){
                    echo "<p class='txt mt-4 mb-3'>[$n3, $n2, $n1]</p>";
                }
            }?>
            </center>
        </div>
