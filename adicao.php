...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu " style="background-color: #14213d !important;"
                            ...
                            <li><a class="dropdown-item nav-fonte nav-selec" href="adicao.php">Adição</a></li>
    ...
    <div class="corpo">
        ...
        <h3 class="txt mt-2 ms-3"><b> Adição - Condicional</b></h3><br>
        <form method="post">
            <span class="txt ms-3">O primeiro valor é </span>
            <input type="text" placeholder="0" class="inputs" name="n1"><br><br>
            <span class="txt ms-3">O segundo valor é </span>
            <input type="text" placeholder="0" class="inputs" name="n2"><br>
            <center>
            ...
            if($_POST){
                ...
                if ($t>20){
                    $t+=8;
                    echo "<p class='txt mt-4 mb-3'> O valor da soma, mais 8, é $t</p>";
                }
                else{
                    $t-=5;
                    echo "<p class='txt mt-4 mb-3'> O valor da soma, menos 5, é $t</p>";
                }
